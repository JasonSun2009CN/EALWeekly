(function(){
  const translations = {
    en: {
      ...
      relatedEpisodes: 'Related articles', archive: 'ARCHIVE', allIssues: 'All issues', chinese: '中文', english: 'English', heroTitle: 'AI, explained for everyone.',
    ...
    zh: {
      ...
      relatedEpisodes: '相关文章', archive: '文章归档', allIssues: '全部文章', chinese: '中文', english: 'English', heroTitle: '用人人都能懂的方式解释 AI。',
